            ...
            <div class="flex-container">
                <main>
                    <article class="panel panel-big text-center">
                        ...
                        <p class="text-left">First of all, let's talk about the achievements. We have reached over <strong>200 webservers</strong>, which is an amazing number. The webserver has been around for a year at this point and we became the biggest CCIR FM "SDR" list worldwide.</p>
                        <p class="text-left">With this, we have also reached <strong>1800 members</strong> on our Discord server, which is amazing, as we're approaching 2000 very quick. That is an unbelievable number and we are thankful for every single one of you.</p>

                        <h3 class="color-main">Finances</h3>
                        <p class="text-left">A huge THANK YOU to all our supporters, this wouldn't be possible without you. We have decided to make 2 sponsored webservers, out of which one will be placed near the <strong>Trutnov/Černá Hora transmitter in Czechia (1300m ASL)</strong>. The second one will be placed near <strong>the Czech / Polish border at around 900m ASL near the mountain peak of Biskupská Kupa</strong>.</p>
                        <p class="text-left">Both of these servers will host an S-dipole. These S-dipoles have been donated to us by <strong>dxc.cz</strong> - thank you for that!
                        With this, we have also bought a third thin client in the meantime to record a <strong>YouTube tutorial</strong> with. This tutorial will show you how to set up a webserver on Linux - Debian specifically.</p>
                        ...
                        <p class="text-left">Domain renewal: <strong>18.58 €</strong><br>
                            Thin clients (Dell Wyse 3040) x2 for sponsored webservers: <strong>51 €</strong><br>
                            Thin client (Dell Wyse 3040) for the YouTube video tutorial: <strong>23.61 €</strong><br>
                            <br>
                            Total cost: <strong>93.19 €</strong>
                        </p>
                        ...
                        <p class="text-left"><strong>FM-DX Servermap</strong> (servers.fmdx.org) will receive an UI overhaul including the new top panel, that you can already see on updated webservers now. All the settings and stats will be moved there to ensure more UI design consistency. With this, we also plan on improving the global webserver settings.</p>
                        <p class="text-left">With this, <strong>FM-DX Webserver</strong> will also receive more bugfix and optimization related attention. The UI design is currently in an ideal state, where it only needs minor polishing. </p>
                        <p class="text-left">We will also let you know about the <strong>full ESP32 FM Firmware major update</strong> soon in a separate article - the same goes for the sponsored webservers, we're very excited for both!</p>
                        <br>
