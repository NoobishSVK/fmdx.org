            ...
            <div class="flex-container">
                <main>
                    <article class="panel panel-big text-center">
                        ...
                        <p class="text-left">We’re happy to announce a new milestone: we now have 150 webservers online at the same time! A big thank you to everyone who uses or hosts these servers for public access.
                        ...
                        <p class="text-left">Unfortunately, our partners at FMDX.pl have lost access to their domain a few weeks ago due to unforeseen circumstances. We have decided to take them under our care and now you can access their content using the site <a href="https://pl.fmdx.org" target="_blank">pl.fmdx.org</a> - this means their very useful content is still accessible for everyone.</p>

                        <h3 class="color-main">RF Rendezvous Discord Partnership</h3>
                        <p class="text-left">We have a new partner! The great folks at RF Rendezvous (the second biggest HAM/DX Discord server) decided to open their gates for FMDX.org and established a mutual partnership. Give them a visit! 
                        <a href="https://discord.gg/SFnY2EgM3v" class="color-main" target="_blank"><strong>RF Rendezvous Discord server</strong></a></p>
                        ...
                        On top of that, we are planning a big map update for maps.fmdx.org - stay tuned for that!
                        </p>
                        <br>
