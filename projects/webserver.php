            ...
            <div class="flex-container">
                <main>
                    <div class="panel panel-big text-center" style="padding: 30px 50px;">
                        ...
                        <p class="text-left">For those interested in further customization, the community offers a selection of user-made widgets, including station logos, custom UI elements or weather.</p>
                        <button class="btn-small m-auto">Browse the plugins list</button>
