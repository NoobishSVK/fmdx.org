            ...
            <div class="flex-container">
                <main>
                    <div class="panel panel-big text-center" style="padding: 30px 50px;">
                        ...
                        <p class="m-0" style="font-size: 24px;"><a href="index.php" class="color-main">Summary</a> <span class="text-gray">•</span> <a href="accessories.php" class="color-main">Accessories</a> <span class="text-gray">•</span> <a href="spareparts.php" class="color-main">Spare Parts</a>
