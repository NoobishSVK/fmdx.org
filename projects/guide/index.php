            ...
            <div class="flex-container">
                <main>
                    <div class="panel panel-big text-center" style="padding: 30px 50px;">
                        <h2>TEF Guide</h2>
                        <p class="text-left">In this guide, we cover everything you need to know about buying portable TEF668x receivers from AliExpress.
                        We provide details for each tuner and offer a general review based on community experience, including pricing, to help you choose the best TEF receiver for your needs.<br>
                        Please remember, we're not responsible for your purchasing decisions.
                        </p>
                        ...
                        <table style="margin: auto;">
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-bold" style="padding: 3px 10px;">09CD03</td>
                                    <td>€3 off (above €29)</td>
                                </tr>
                                <tr>
                                    <td class="text-bold" style="padding: 3px 10px;">09CD08</td>
                                    <td>€8 off (above €69)</td>
                                </tr>
                                <tr>
                                    <td class="text-bold" style="padding: 3px 10px;">09CD20</td>
                                    <td>€20 off (above €169)</td>
                                </tr>
                                <tr>
                                    <td class="text-bold" style="padding: 3px 10px;">09CD30</td>
                                    <td>€30 off (above €239)</td>
                                </tr>
                                <tr>
                                    <td class="text-bold" style="padding: 3px 10px;">09CD50</td>
                                    <td>€50 off (above €369)</td>
                                </tr> 
                            </tbody>
                        </table>
                        <p>These coupons are available from September 1st 2024</p>
                        <br>
                        <hr>
